...
{
    public class UpdateTagCloudCommandHandler : IRequestHandler<UpdateTagCloudComment>
    {
        ...
        public async Task Handle(UpdateTagCloudComment request, CancellationToken cancellationToken)
        {
