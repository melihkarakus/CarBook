...
{
    public class RemoveTagCloudCommandHandler : IRequestHandler<RemoveTagCloudComment>
    {
        ...
        public async Task Handle(RemoveTagCloudComment request, CancellationToken cancellationToken)
        {
