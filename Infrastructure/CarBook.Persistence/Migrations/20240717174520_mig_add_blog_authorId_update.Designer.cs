...
namespace CarBook.Persistence.Migrations
{
    ...
    [Migration("20240717174520_mig_add_blog_authorId_update")]
    partial class mig_add_blog_authorId_update
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarBook.Domain.Entites.CarPricing", b =>
                {
                    b.HasOne("CarBook.Domain.Entites.Car", "Cars")
                        .WithMany("CarPricings")
                        .HasForeignKey("CarID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarBook.Domain.Entites.Pricing", "Pricings")
                        .WithMany("CarPricings")
